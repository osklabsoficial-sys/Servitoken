...
import { Users, Store, Server, ArrowRight } from "lucide-react";
            ...
            <Reveal delay={0.15}>
              <div className="mt-7">
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="h-11 border-white/15 bg-white/[0.04] px-6 text-foreground transition-colors hover:bg-white/[0.08] hover:border-white/25"
                >
                  <Link href="#utilidad">
                    {whatIs.cta}
            ...
            <div className="mt-9 space-y-3">
              {whatIs.points.map((point, i) => (
                <Reveal key={point.title} delay={0.2 + i * 0.08}>
                  <div className="flex items-start gap-3.5 rounded-xl border border-white/[0.08] bg-white/[0.02] p-4 transition-colors hover:border-electric/20 hover:bg-electric/[0.03]">
                    <span className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-electric/15 text-electric-bright ring-1 ring-electric/20">
...
function EcosystemDiagram() {
  return (
    <div className="relative mx-auto aspect-square w-full max-w-md">
      ...
      <div className="absolute inset-0 -z-10 rounded-full bg-grid opacity-25" />
      ...
      <svg
        ...
        aria-hidden="true"
      >
        <line x1="200" y1="40" x2="200" y2="200" stroke="rgba(46,107,255,0.30)" strokeWidth="1.5" strokeDasharray="4 6" />
        <line x1="60" y1="330" x2="200" y2="200" stroke="rgba(212,176,106,0.30)" strokeWidth="1.5" strokeDasharray="4 6" />
        <line x1="340" y1="330" x2="200" y2="200" stroke="rgba(212,176,106,0.30)" strokeWidth="1.5" strokeDasharray="4 6" />
      </svg>
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <motion.div
          ...
          className="glow-gold rounded-3xl border border-gold/30 bg-navy-2/80 p-3 backdrop-blur-sm"
        >
      ...
      {nodes.map((node, i) => (
        ...
        >
          <div className="glass-card flex flex-col items-center gap-1.5 rounded-2xl px-4 py-3 text-center">
            <span className="flex size-9 items-center justify-center rounded-lg bg-white/5 text-gold ring-1 ring-white/10">
